...
> ⚠️ **Moved.** GQL and Graph-Model internals are now owned by **`graph-agent`** — canonical
> reference: `../graph-agent/gql_reference.md`. This file is kept as a legacy pointer.
